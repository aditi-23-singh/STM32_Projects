...
typedef struct {
    ...
    uint32_t fast_blink_ms;
    uint32_t slow_blink_ms;
...
void LED_Controller_InitWithTimings(LED_Controller_t *ctrl, LED_Mode_t initial_mode,uint32_t fast_blink_ms, uint32_t slow_blink_ms, uint32_t duration_ms);
