...
bool TMC2208_ReadGCONF_Raw(TMC2208_t *driver, uint32_t *value) {
    ...
    return TMC_ReadRegister(driver, TMC2208_GCONF, value);
}
...
static void parseIHOLD_IRUN(uint32_t raw_value, TMC2208_IHOLD_IRUN_t *ihold_irun) {
